...
![](figures/conditional-prob-ttriad.png){width="80%" fig-align="center"}

When $\coef_{\mbox{ttriad}} = 1$ (second row), Cor(transitive triads, mutual ties) $\to 1$, and VIF is > 4,500.
...
::: {.column width="50%"}
![](figures/vif-n%3D5.png){width="85%" fig-align="center"}
:::

::: {.column width="50%"}
![](figures/cor-n%3D5.png){width="85%" fig-align="center"}
:::
